...
Útgáfa: **18.1** · Stutt tungumál innfædd (9): Polski, Deutsch, English, Español, Suomi, Français, Íslenska, Italiano, Русский.
...
Forritið skiptir verkefnum á milli tveggja API-veitenda á snjallan hátt, til að hámarka gæði prósa, kostnað og hraða:

* **Anthropic Claude Sonnet 4.6:** Vél fyrir alla skapandi frásögn. Ber ábyrgð á leikstjórn handrita, skrifum hefðbundinnar prósa (Hljóðbók), Hugstormun og ALLA söguhami (Val, Minna Illa, Frjáls) ásamt því að búa til samantektir og kvikmyndalegar innskot. Flutningur frásagnar til Claude (Leikstjóri í v18.0, Sögur í v18.1) var afleiðing af reynslusönnuðum yfirburðum í að halda sig við reglur heimsins og forðast klisjur.
* **gpt-4o (OpenAI):** Háþróuð þýðing með varðveislu margra blokka samhengis (Tungumálasérfræðingur). Flutningur til Anthropic er áætlaður í næstu útgáfu.
* **gpt-4o-mini (OpenAI):** Hratt, létt hjálparlíkön fyrir smáverkefni: endurtekin veiting bókmenntatitla fyrir framleiddar kafla og útdráttur ISO tungumálakóða.
