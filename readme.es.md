...
Versión: **18.4.0** · Idiomas soportados de forma nativa (9): Polski, Deutsch, English, Español, Suomi, Français, Íslenska, Italiano, Русский.
...
Juegos de texto interactivos dirigidos por IA en el papel de motor narrativo. A diferencia de la Dirección (donde generas un audiolibro terminado), las Opowieści son una narrativa dinámica turno a turno:
...
* **Modo Menor Mal:** como Elecciones, pero cada opción es desfavorable moral, física o estratégicamente. Desde v15.2 una "ampolla" adicional — opción de rescate desesperado reutilizable numerada CERO, cuyos efectos son pseudorandom (60% perjudiciales / 30% alteran la percepción / 10% raramente beneficiosos, distribución forzada por Python, LLM no puede inventar un resultado salvador).
...
* **Un modelo de IA para todos los modos:** desde v18.1 todos los modos de Opowieści utilizan Anthropic Claude Sonnet 4.6 — un modelo más potente que sigue estrictamente las reglas del mundo (crucial especialmente en el modo Menor Mal, donde cada opción debe ser realmente desfavorable).
