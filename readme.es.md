...
Versión: **18.5.1** · Idiomas soportados de forma nativa (9): Polski, Deutsch, English, Español, Suomi, Français, Íslenska, Italiano, Русский.
...
### 2. Opowieści (Ctrl+2, segundo modo principal desde v15.0)

Juegos de texto interactivos dirigidos por IA en el rol de motor narrativo. A diferencia de la Reżyseria (donde generas un audiolibro terminado), Opowieści es una trama dinámica por turnos:
...
* **Un único modelo de IA para todos los modos:** desde v18.1 todos los modos de Opowieści utilizan el mismo modelo compartido (por defecto y recomendado: Anthropic Claude Sonnet 4.6) — un modelo más potente se ciñe rigurosamente a las reglas del mundo (especialmente importante en el modo Mal Menor, donde cada opción debe ser genuinamente desfavorable).
...
El proveedor de IA recomendado y predeterminado es Anthropic (Claude) — todos los prompts del sistema están ajustados para él, por lo que ofrece la mayor calidad narrativa, el mejor respeto a las reglas del mundo y la prosa más natural. La consolidación en Claude se realizó por etapas (Reżyser en v18.0, Opowieści en v18.1, Poliglota y posproducción en v18.2) — resultado de una ventaja empíricamente confirmada en el respeto a las reglas del mundo, la naturalidad de la prosa y la evitación de clichés.

* **Anthropic Claude Sonnet 4.6 (pilar de calidad predeterminado):** Motor de TODA la inteligencia de la aplicación. Responsable de la narrativa creativa (dirección de guiones, escritura de prosa tradicional de Audiolibro, Lluvia de Ideas y TODOS los modos de Opowieści — Elecciones, Mal Menor, Libre — junto con la generación de resúmenes e interludios Cinematic), traducciones avanzadas con preservación del contexto multibloques (Poliglota), así como microtareas: asignación iterativa de títulos literarios a capítulos y detección del código de idioma del contenido.
