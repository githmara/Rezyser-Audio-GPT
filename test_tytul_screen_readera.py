...
Uruchom:  .venv/Scripts/python -m pytest test_tytul_screen_readera.py -q
Albo jako skrypt (deleguje do pytesta): .venv/Scripts/python test_tytul_screen_readera.py
"""
