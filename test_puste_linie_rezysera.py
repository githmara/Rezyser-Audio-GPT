...
Uruchom:  .venv/Scripts/python -m pytest test_puste_linie_rezysera.py -q
Albo jako skrypt (deleguje do pytesta): .venv/Scripts/python test_puste_linie_rezysera.py
"""
